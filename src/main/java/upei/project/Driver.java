...
public class Driver {
    ...
    public static ArrayList<BoardSquare> createBoard(){
        ...
        boardMap.add(new WildSquare(4, "TAX"));
        ...
        boardMap.add(new Country(10, "EMPTY FOR NOW", 2, 60));
        ...
        boardMap.add(new Country(20, "EMPTY FOR NOW", 2, 60));
        ...
        boardMap.add(new Country(30, "DELETE LATER", 24, 280));
        ...
        boardMap.add(new WildSquare(38, "TAX"));
